document.addEventListener('DOMContentLoaded', () => {
    ...
    const duobaotaDb = {
        '興': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/xing.jpg?v=v9.1', 
            desc: '真迹：出自《多宝塔碑》“千福寺兴工”。结体开阔，上方错落有致，下方支撑有力。' 
        },
        '旺': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/wang.jpg?v=v9.1', 
            desc: '真迹：出自颜真卿《勤礼碑》。日字旁挺拔，整体端庄稳重，尽显颜体丰腴之美。' 
        },
        '發': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/fa.jpg?v=v9.1', 
            desc: '真迹：出自《多宝塔碑》“发明资乎十力”。撇画舒展，内部穿插有序，笔力雄健。' 
        },
        '達': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/da.jpg?v=v9.1', 
            desc: '真迹：出自《多宝塔碑》“通达”。走之底有力，内部结构紧凑，重心极稳。' 
        },
        '永': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/yong.jpg?v=v9.1', 
            desc: '起笔圆润，侧锋转折有力，是练习颜体的入门经典。' 
        },
        '和': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/he.jpg?v=v9.1', 
            desc: '结构左右平衡，线条粗细变化丰富，体现了颜体的宽博。' 
        },
        '九': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/jiu.jpg?v=v9.1', 
            desc: '极简之字，却最显功力。撇画有力，横折钩饱满。' 
        },
        '年': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/nian.jpg?v=v9.1', 
            desc: '中轴线挺拔，横画平稳，展现了颜体书法的厚重感。' 
        },
        '多': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/duo.jpg?v=v9.1', 
            desc: '两夕相叠，错位而生动，重心极其稳固。' 
        },
        '寶': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/bao.jpg?v=v9.1', 
            desc: '宝盖头宽阔，内部结构充实，体现了“颜筋”的质感。' 
        },
        '塔': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/ta.jpg?v=v9.1', 
            desc: '土字旁稳健，右侧结构复杂但安排合理，密而不乱。' 
        },
        '碑': { 
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/bei.jpg?v=v9.1', 
            desc: '石字旁坚实，右侧笔画舒展，气势开阔。' 
        },
        '大': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/da_large.jpg?v=v9.1',
            desc: '横画平铺，撇捺舒展，尽显大唐气象。'
        },
        '唐': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/tang.jpg?v=v9.1',
            desc: '结构宏大，笔力千钧，是多宝塔碑的典型风格。'
        },
        '西': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/xi.jpg?v=v9.1',
            desc: '方正厚重，内部空间安排巧妙，稳定而有灵动感。'
        },
        '京': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/jing.jpg?v=v9.1',
            desc: '上方点画有力，下方支撑稳固，结构严谨。'
        },
        '龍': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/long.jpg?v=v9.1',
            desc: '笔画繁复 but 交代清晰，龙字气势磅礴。'
        },
        '寺': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/si.jpg?v=v9.1',
            desc: '横平竖直中见变化，体现了颜楷的规矩与方圆。'
        },
        '僧': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/seng.jpg?v=v9.1',
            desc: '人字旁挺拔，右侧结构紧凑，整体神采飞扬。' 
        },
        '一': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/yi.jpg?v=v9.1',
            desc: '蚕头燕尾，一笔见真章，颜体横画的极致表现。'
        },
        '心': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/xin.jpg?v=v9.1',
            desc: '卧钩圆润有力，点画分布自然，灵动非凡。'
        },
        '國': {
            img: 'http://hu.witplay.com/yan_shufa/assets/shufa_v9/guo.jpg?v=v9.1',
